    ...
    <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      >
        ...
        <p className="flex items-center gap-1">
          <span>Create your first thumbnail for free</span>
          <ChevronRightIcon
            size={16}
      ...
      <motion.h1
        className="text-5xl/17 md:text-6xl/21 font-medium max-w-[900px] text-center"
      ...
      >
        <Link
          href={"/generate"}
          className="bg-pink-600 hover:bg-pink-700 text-white rounded-full px-7 h-11 flex items-center justify-center transition-all duration-300"
        >
          Get Started
        </Link>
        <button className="flex items-center gap-2 border border-pink-900 hover:bg-pink-950/50  rounded-full px-6 h-11 transition-all duration-300">
