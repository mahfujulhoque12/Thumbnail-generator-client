import { ThumbnailStyle, thumbnailStyles } from "@/public/assets";
import {
  ChevronDownIcon,
  CpuIcon,
  ImageIcon,
  ...
  return (
    <div className="relative space-y-3 dark">
      ...
      <button
        ...
        className="flex w-full justify-between rounded-md items-center border px-4 py-3 text-left transition bg-white/8  border-white/10 text-zinc-200 hover:bg-white/12 mt-2"
      >
      ...
      {isOpen && (
        <div className="absolute bottom-0 z-50 mt-1 w-full border rounded-md border-white/12 bg-black/20 backdrop-blur-3xl shadow-lg">
